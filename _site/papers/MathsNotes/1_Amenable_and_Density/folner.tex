...
A sequence of sets \(\Phi=(\Phi_N)_{N\in\mathbb{N}}\) will be said to be
\emph{tempered} if, for some \(b>0\) and all \(n\in\mathbb{N}\),
...
\tightlist
\item
  Every Følner sequence \(\Phi=(\Phi_N)_{N\in\mathbb{N}}\) has a
